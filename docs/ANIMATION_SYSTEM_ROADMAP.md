...
- Authoring workflow documented end-to-end; tutorial verified by sample project *(validated via `docs/animation_workflows.md#end-to-end-authoring-tutorial` + sample scenes mentioned in `docs/animation_milestone_5_plan.md`).*
