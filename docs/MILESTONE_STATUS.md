...
| 10 ΓÇô Scene Graph & Serialization | Complete | Scene structs, save/load with dependency tracking + ref-counted assets (`src/scene.rs:1`, `src/ecs/world.rs:887`, `src/app/mod.rs:742`) | Evaluate binary `.kscene` format (`KESTREL_ENGINE_ROADMAP.md:173`) and automated scene round-trip tests |
