...
| 12 ΓÇô 3D Extension | Complete | glTF mesh path, material registry, HDR environment lighting, camera controls, mesh preview plugin (`src/mesh.rs:1`, `src/material_registry.rs:1`, `src/environment.rs:1`, `src/mesh_preview.rs:1`) | Pursue advanced shadow/culling techniques (`KESTREL_ENGINE_ROADMAP.md:202`) and GPU perf baselines |
