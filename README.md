...
- Plugin system - The new `EnginePlugin` trait plus runtime registry lets subsystems (like audio) hook into init/update/fixed/event stages without modifying the core loop, paving the way for third-party extensions.
